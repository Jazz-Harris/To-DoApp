...
const style = {
  bg: `w-screen `,
  banner: `w-screen bg-slate-800 text-white sm:text-sm md:text-md lg:text-2xl  font-bold top-0 p-2 h-fit m-auto flex pb-12 rounded-sm relative  items-center justify-center grid grid-cols-3 content-between`,
